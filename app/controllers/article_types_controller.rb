class ArticleTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @article_type.save
        format.html { redirect_to @article_type, notice: 'ArticleType was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @article_type.update(article_type_params)
        format.html { redirect_to @article_type, notice: 'ArticleType was successfully updated.' }
  ...
  private
    ...
    def article_type_params
      params.require(:article).permit(:name, :fields)
    end
end
